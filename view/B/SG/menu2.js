...
document.write('\
    ...
    \
            if(memberEmail == null || memberEmail == "") {\
                ...
                document.getElementById("favouriteLink").classList.add("disabled-link");\
            } else {\
    ...
    \
            ...
            document.getElementById("favouriteLink").setAttribute("href", "/B/" + countryPrefix + "/favourite.html?cat=" + encodeURIComponent("Favourite"));\
        }, false);\
    \
        function logout() {\
            ...
            <div id="menuLoggedOut" style="display: none;">\
                <nav>\
                    <ul class="nav nav-pills nav-top">\
                        ...
                        <li>\
                        <a href="/B/' + countryPrefix + '/services.html"><i class="icon icon-wrench"></i>Services</a>\
                    </li>\
                        <li>\
